...
def groundtruth(window,path):
	...
	#Frame 117
	if(path == "images/Frame117.jpg"): ####ESTA E A MELHOR FRAME PARA EXPLICARMOS O NOSSO PROBLEMA COM O ENQUADRAMENTO
		groundtruth[350] = 2
		groundtruth[351] = 2
		groundtruth[390] = 2
		groundtruth[391] = 2
	...
	#Frame 679
	elif(path == "images/Frame673.jpg"):
		# groundtruth[728] = 2
		groundtruth[768] = 2

	#Frame 679
	elif(path == "images/Frame676.jpg"):
		groundtruth[728] = 2
		groundtruth[729] = 2
	...
	#Frame 2494
	elif(path == "images/Frame_salvamento2494.jpg"):
		groundtruth[109] = 2
		# groundtruth[110] = 2

	#Frame 2497
	elif(path == "images/Frame_salvamento2497.jpg"):
		groundtruth[109] = 2
		# groundtruth[110] = 2
	...
	#Frame 2503
	elif(path == "images/Frame_salvamento2503.jpg"):
		groundtruth[109] = 2
		# groundtruth[110] = 2
		groundtruth[129] = 2
		# groundtruth[130] = 2
...
def process_video(video,out,classi, windowsize_r, windowsize_c):
	...
	while(video.isOpened()):
		...
		if cv.waitKey(30) & 0xff == ord('q') or idx == 2530:
			break    
...
if __name__=="__main__":
	...
	out = cv.VideoWriter('images/frames_2490_2530_classi.avi', cv.cv.CV_FOURCC('X','V','I','D'), 2, (1280,720))
	# out = 0
